...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team tactics and compete in interschool matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["ryan@mergington.edu", "hannah@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training and fitness for all skill levels",
    ...
    "Debate Team": {
        "description": "Develop persuasive speaking and research skills",
